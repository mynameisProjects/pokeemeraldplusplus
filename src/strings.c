...
const u8 gText_ScaleOpponents[] = _("TRAINER SCALING");
...
const u8 gText_ScaleOpponentsOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_ScaleOpponentsOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
...
const u8 gText_PutMonAway[] = _("PUT AWAY");
const u8 gText_PullMonOut[] = _("FOLLOW");
