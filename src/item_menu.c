...
static const u16 sItemsByType[ITEMS_COUNT] =
{
    ...
    [ITEM_RETRO_MAIL] = ITEM_TYPE_MAIL,
        ...
        [ITEM_HEALTH_BOTTLE_CAP] = ITEM_TYPE_SELLABLE,
        [ITEM_MUSCLE_BOTTLE_CAP] = ITEM_TYPE_SELLABLE,
        [ITEM_RESIST_BOTTLE_CAP] = ITEM_TYPE_SELLABLE,
        [ITEM_GENIUS_BOTTLE_CAP] = ITEM_TYPE_SELLABLE,
        [ITEM_CLEVER_BOTTLE_CAP] = ITEM_TYPE_SELLABLE,
        [ITEM_SWIFT_BOTTLE_CAP] = ITEM_TYPE_SELLABLE,
